    ...
    return (
        <Card className={`w-full flex flex-col items-stretch gap-4 md:gap-5`}>
            <div className={"flex max-md:flex-col items-start justify-between md:items-stretch gap-4 md:gap-5"}>
                <div className={"flex items-center justify-start gap-4 md:gap-5 h-full max-w-full min-w-0"}>
                    <ProfileAvatar avatarUrl={userAvatarUrl} isOnline={isOnline}/>
                    <div className={"flex flex-col gap-2.5 sm:gap-3 md:gap-4 lg:gap-5 min-w-0 max-w-full"}>
                        ...
                        <div className={"flex flex-col md:hidden items-start max-w-full"}>
                            {userShared}
                        </div>
                    </div>
                </div>

                <div className={"max-md:hidden flex flex-col items-end justify-between text-dark/60 py-2.5 shrink-0"}>
